node {
	...
	stage('SonarQube analysis'){
		...
		powershell '''
			...
			.\\sonar-scanner.bat -X -D sonar.projectKey=onePipeline -D sonar.projectName=DotNetHello -D sonar.projectVersion=2.0 -D sonar.login=admin -D sonar.password=admin -D sonar.projectBaseDir="C:\\Users\\610169\\Desktop\\DotnetApp\\Hello\\" -D sonar.sources="C:\\Users\\610169\\Desktop\\DotnetApp\\Hello\\Hello.sln"
		'''
		}
	}
}